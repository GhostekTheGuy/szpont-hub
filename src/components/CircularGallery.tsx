...
class App {
  ...
  constructor(
    ...
    this.itemCount = items?.length || 12;
  ...
  onCheck() {
    ...
    if (this.onItemFocus && this.itemCount > 0) {
      const focusedIndex = itemIndex % this.itemCount;
      this.onItemFocus(focusedIndex);
    }
  }
...
export default function CircularGallery({
  ...
  useEffect(() => {
    ...
    const app = new App(containerRef.current, {
      ...
      scrollSpeed,
      scrollEase,
      onItemFocus: (index: number) => onItemFocusRef.current?.(index)
    });
    return () => {
      app.destroy();
    };
